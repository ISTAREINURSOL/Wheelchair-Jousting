...
func set_darkmode(darkmode : bool):
    if darkmode:
        ...
        contents_tree.set("custom_styles/focus", load("res://addons/github-integration/resources/styles/ContentesBG-dark.tres"))   
    else:
        $BG.color = "#f6f8fa"
        ...
        contents_tree.set("custom_styles/focus", load("res://addons/github-integration/resources/styles/ContentesBG-white.tres"))
